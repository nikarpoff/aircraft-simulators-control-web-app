...
public class ComponentState extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ComponentState(String id, Integer responseTime, Integer temperature, Integer power, Integer voltage) {
    this.id = id;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: responseTime = (Integer)value$; break;
    case 2: temperature = (Integer)value$; break;
    case 3: power = (Integer)value$; break;
    case 4: voltage = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static org.simulator.dto.ComponentState.Builder newBuilder() {
    return new org.simulator.dto.ComponentState.Builder();
  }
   ...
   * @return A new ComponentState RecordBuilder
   */
  public static org.simulator.dto.ComponentState.Builder newBuilder(org.simulator.dto.ComponentState.Builder other) {
    if (other == null) {
      return new org.simulator.dto.ComponentState.Builder();
    } else {
      return new org.simulator.dto.ComponentState.Builder(other);
    }
  }
   ...
   * @return A new ComponentState RecordBuilder
   */
  public static org.simulator.dto.ComponentState.Builder newBuilder(org.simulator.dto.ComponentState other) {
    if (other == null) {
      return new org.simulator.dto.ComponentState.Builder();
    } else {
      return new org.simulator.dto.ComponentState.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ComponentState>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.simulator.dto.ComponentState.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.simulator.dto.ComponentState other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder setId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder setResponseTime(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder clearResponseTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder setTemperature(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder clearTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder setPower(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder clearPower() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder setVoltage(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.simulator.dto.ComponentState.Builder clearVoltage() {
    ...
    public ComponentState build() {
      try {
        ...
        record.responseTime = fieldSetFlags()[1] ? this.responseTime : (Integer) defaultValue(fields()[1]);
        record.temperature = fieldSetFlags()[2] ? this.temperature : (Integer) defaultValue(fields()[2]);
        record.power = fieldSetFlags()[3] ? this.power : (Integer) defaultValue(fields()[3]);
        record.voltage = fieldSetFlags()[4] ? this.voltage : (Integer) defaultValue(fields()[4]);
        return record;
